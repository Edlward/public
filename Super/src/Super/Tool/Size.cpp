...
/*!
  \fn void QSize::scale(int width, int height, Sp::AspectRatioMode mode)

    Scales the size to a rectangle with the given \a width and \a
    height, according to the specified \a mode:

    \list
    \li If \a mode is Sp::IgnoreAspectRatio, the size is set to (\a width, \a height).
    \li If \a mode is Sp::KeepAspectRatio, the current size is scaled to a rectangle
       as large as possible inside (\a width, \a height), preserving the aspect ratio.
    \li If \a mode is Sp::KeepAspectRatioByExpanding, the current size is scaled to a rectangle
...
/*!
    \fn void QSize::scale(const QSize &size, Sp::AspectRatioMode mode)
    \overload
...
/*!
    \fn QSize QSize::scaled(int width, int height, Sp::AspectRatioMode mode) const
    \since 5.0
...
*/
//QSize QSize::scaled(const QSize &s, Sp::AspectRatioMode mode) const
//{
...
/*!
  \fn void QSizeF::scale(qreal width, qreal height, Sp::AspectRatioMode mode)
...
/*!
    \fn void QSizeF::scale(const QSizeF &size, Sp::AspectRatioMode mode)
    \overload
...
/*!
    \fn QSizeF QSizeF::scaled(qreal width, qreal height, Sp::AspectRatioMode mode) const
    \since 5.0
...
/*!
    ...
    according to the specified \a mode.
*/
//QSizeF QSizeF::scaled(const QSizeF &s, Sp::AspectRatioMode mode) const
//{

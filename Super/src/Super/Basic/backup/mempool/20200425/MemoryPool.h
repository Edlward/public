...
public:
    void TestMemSize(size_t nSize)
    {
        size_t RES=0;
        size_t blockNum;
        size_t BlockMgrMaxSize;
        blockNum=SizeToBlockNumStrategy1(nSize);
        BlockMgrMaxSize=BlockNumToSizeStrategy1(blockNum);
        ...
        blockNum=SizeToBlockNumStrategy2(nSize);
        BlockMgrMaxSize=BlockNumToSizeStrategy2(blockNum);
        ...
        blockNum=SizeToBlockNumStrategy3(nSize);
        BlockMgrMaxSize=BlockNumToSizeStrategy3(blockNum);
        ...
        blockNum=SizeToBlockNumStrategy4(nSize);
        BlockMgrMaxSize=BlockNumToSizeStrategy4(blockNum);
        ...
        blockNum=SizeToBlockNumStrategy5(nSize);
        BlockMgrMaxSize=BlockNumToSizeStrategy5(blockNum);

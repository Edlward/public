...
class RedBlackTreeNode
{
    public:
        T key;                                   // 关键字(键值)
        RBTColor color;                    // 颜色
        RedBlackTreeNode *left;      // 左孩子
        RedBlackTreeNode *right;    // 右孩子
        RedBlackTreeNode *parent; // 父结点
...
class RedBlackTree 
{
    ...
    private:
        ...
        // 查找最小结点：返回pNode为根结点的红黑树的最小结点。
        RedBlackTreeNode<T>* minimum(RedBlackTreeNode<T>* pNode);
        // 查找最大结点：返回pNode为根结点的红黑树的最大结点。
